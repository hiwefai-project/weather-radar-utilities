...
#current_time = datetime(2025, 3, 18, 22, 10, 00)

# Get the minutes
minutes =  float(current_time.strftime('%M'))


#print(base_path, current_time, int(minutes/10), minutes/10)
...
if int(minutes/10) == minutes/10:
    ...
    #file_path ="/home/ccmmma/prometeo/dev/weather-radar"
